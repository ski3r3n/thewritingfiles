      ...
      <div className="flex">
        ...
        <div className="overflow-y-auto h-screen p-10">
          ...
          <div className="flex gap-4 mb-6">
            <Link href="/dashboard/profile/fufu" className="flex items-center gap-2"> {/* placeholder link, doesnt even work */}
              <h2 className="text-xl text-gray-600">By: Fu Fu</h2>
            </Link>
            <h2 className="text-xl text-gray-600">Date: 12/25/25</h2>
          </div>
          <p className="text-lg max-w-5xl">
            ...
            My hand sees visions of another place. It is willed by the strength of the mind, but it is restrained by its ability, it wants and wants, with such an endless ambition, till it gouges its own eyes. I love my hands.</p>
        </div>
      </div>
    </>
  );
